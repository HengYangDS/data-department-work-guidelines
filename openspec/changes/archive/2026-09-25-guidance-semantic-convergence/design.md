...
| 6-7, oral and written communication                                | `docs/communicate.md` owns purpose, meeting, escalation, and fidelity, clarity, and elegance. Eleven-section document templates and phrase substitution tables are dropped as over-prescription; their actionable limits remain. |
...
reader comprehends the material unaided, that a live task used it, or that the
department improved. Those claims need observations at the producing work system
