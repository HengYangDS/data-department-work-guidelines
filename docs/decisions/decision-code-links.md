...
| DR-0004 ETHOS adopter | [`.ethos/profile.toml`](../../.ethos/profile.toml)、[`.githooks/`](../../.githooks/)、[`evidence/`](../../evidence/) | `./scripts/ethos-repo.sh prove --execute --scope docs --expect-head <HEAD> --json` |
